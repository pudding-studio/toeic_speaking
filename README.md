...
| 학습 계획 | 1주·2주·3주·한 달 커리큘럼, 날짜별 할 일 체크 |
...
- **학습 계획** — 시험까지 남은 기간을 고르면 날짜별 할 일이 나옵니다. 아래 "학습 계획" 참고.
...
시험까지 남은 기간에 맞춰 계획을 고르면, 매일 어느 파트를 몇 문항 풀고 실전을 언제 볼지
날짜별로 나옵니다. 할 일을 누르면 체크되고, 오른쪽 화살표를 누르면 해당 연습 화면으로
바로 갑니다.

| 계획 | 기간 | 하루 평균 | 전체 문항 | 실전 |
| --- | --- | --- | --- | --- |
| 1주 완성 | 7일 | 14분 | 40문항 | 2회 |
| 2주 완성 | 14일 | 10분 | 58문항 | 3회 |
| 3주 완성 | 21일 | 9분 | 76문항 | 4회 |
| 한 달 완성 | 28일 | 9분 | 100문항 | 5회 |

- 하루 평균 시간은 각 파트의 **실제 준비·답변 시간에 2를 곱해** 계산합니다. 말한 답을
  한 번 더 듣고 정리하는 시간까지 감안한 값입니다. 모의고사는 1회를 20분으로 셉니다.
- 날짜는 계획을 시작한 날을 1일째로 셉니다. 밀린 날의 할 일도 그대로 남아 있어
  나중에 채울 수 있고, 미리 해 두는 것도 됩니다.
- 계획에 적힌 문항 수는 문제 은행에 있는 문항 수보다 많을 수 있습니다. 일부러 그렇게
  짰습니다. 스피킹은 같은 문항을 다시 푸는 것이 낭비가 아니라 두 번째부터 문장이 붙는
  종목이라, 같은 문항이 다시 나오면 그대로 다시 풀면 됩니다.
- 진행 상태는 이 브라우저에만 저장됩니다. 계획을 바꾸면 체크는 초기화되고 녹음은 남습니다.

계획 내용은 `lib/data/curricula.dart` 에 있습니다. 날짜별 주제·할 일·한 줄 조언을
직접 고쳐 쓸 수 있습니다.
...
│   └── curriculum_store.dart      진행 중인 계획과 체크 상태
├── screens/
...
│   ├── curriculum_tab.dart        "학습 계획" 탭(오늘 할 일·전체 일정)
│   ├── curriculum_picker_screen.dart  계획 고르기
